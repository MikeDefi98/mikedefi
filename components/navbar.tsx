      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <nav className="flex items-center justify-between h-20" aria-label="Main navigation">
          <a href="#home" className="flex items-center gap-2 group">
            <div className="relative h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center border border-primary/30 group-hover:border-primary/60 transition-colors">
              <span className="text-primary font-mono font-bold text-lg">M</span>
      ...
      {isMobileOpen && (
        <div className="lg:hidden bg-background/95 backdrop-blur-xl border-t border-border">
          <div className="px-6 py-6 flex flex-col gap-2">
            ...
            <a
              href="#contact"
              className="mt-2 px-6 py-3 bg-primary text-primary-foreground font-medium text-sm rounded-lg text-center hover:bg-primary/90 transition-all"
              onClick={() => setIsMobileOpen(false)}
            >
              Request a Quote
            </a>
