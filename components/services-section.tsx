...
const services = [
  ...
  },
  {
    ...
    description:
      "Complex auto-trading bots engineered for businesses and firms in the crypto industry. Algorithmic strategies, real-time execution, and institutional-grade reliability.",
