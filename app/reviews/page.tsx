...
export const metadata: Metadata = {
  title: "Mike Web Reviews | Client Testimonials & Ratings – mikedefi.com",
  description:
    "Read verified client reviews of Mike Web (mikedefi.com). Real testimonials from businesses and developers who worked with Mike Web on web development, app development, and crypto automation projects.",
  keywords:
    "Mike Web review, mikedefi.com review, Mike Defi review, Mike Web testimonials, is Mike Web legit, Mike Web clients",
  openGraph: {
    title: "Mike Web Reviews | Client Testimonials & Ratings – mikedefi.com",
    description:
      "Verified client reviews for Mike Web (mikedefi.com). Trusted web development studio since 2015.",
    url: "https://mikedefi.com/reviews",
    siteName: "Mike Web",
  },
}
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "Mike Web",
  alternateName: ["mikedefi.com", "Mike Defi", "Mike Web Dev Studio"],
  ...
  return (
    <>
      ...
      <SeoPageLayout
        ...
        subtitle="Mike Web (mikedefi.com)"
        ...
        <div className="flex flex-col sm:flex-row items-start gap-4 p-6 rounded-xl bg-secondary border border-border">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              projects with Mike Web (mikedefi.com). We do not solicit, incentivize, or fabricate
              reviews. Client identity details are shared with permission. For questions about any
              review, contact us at{" "}
              <a href="mailto:admin@mikedefi.com" className="text-primary hover:underline">
                admin@mikedefi.com
              </a>
              .
            </p>
            ...
            {[
              {
                ...
                a: "Yes. Every review on this page comes from a verified client who engaged Mike Web (mikedefi.com) for a real project. We have never purchased or fabricated reviews.",
              },
              {
                q: "How do I verify a Mike Web testimonial?",
                a: "You can reach out to us directly at admin@mikedefi.com and request reference contact details for any past client (with their consent). We are happy to facilitate direct reference calls.",
              },
              {
