...
export const metadata: Metadata = {
  title: "Mike Web Security | How mikedefi.com Protects Your Project & Data",
  description:
    "Learn about the security practices at Mike Web (mikedefi.com). Secure development standards, data handling policies, payment protection, and client confidentiality practices used on every project.",
  keywords:
    "Mike Web security, mikedefi.com security, Mike Defi secure, Mike Web data protection, Mike Web safe, is mikedefi.com safe",
  openGraph: {
    title: "Mike Web Security | How mikedefi.com Protects Your Project & Data",
    description:
      "Security-first development practices at Mike Web. Trusted by 150+ clients worldwide.",
    url: "https://mikedefi.com/security",
    siteName: "Mike Web",
  },
}
...
const jsonLd = {
  ...
  description:
    "Security practices and data protection policies at Mike Web (mikedefi.com). How we protect client projects, data, and credentials.",
  url: "https://mikedefi.com/security",
  about: {
    "@type": "Organization",
    name: "Mike Web",
  ...
  mainEntity: {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Is mikedefi.com safe to work with?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      >
        ...
        <section>
          ...
          <div className="flex flex-col gap-4">
            {[
              {
                q: "Is mikedefi.com safe to work with?",
