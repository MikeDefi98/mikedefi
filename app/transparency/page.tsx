...
export const metadata: Metadata = {
  title: "Mike Web Transparency | Business Information & Company Background – mike3web.com",
  description:
    "Full transparency about Mike Web (mike3web.com). Business history since 2015, service pricing model, team background, how projects are scoped, and contact verification details.",
  keywords:
    "Mike Web transparency, mike3web.com about, Mike Web background, Mike Web company info, Mike Web legitimate, Mike Web business details",
  openGraph: {
    title: "Mike Web Transparency | Business Information – mike3web.com",
    description:
      "Open company information for Mike Web (mike3web.com). Registered address, history, team, and pricing model.",
    url: "https://mike3web.com/transparency",
    siteName: "Mike Web",
  },
}
...
const jsonLd = {
  ...
  "@type": "Organization",
  name: "Mike Web",
  alternateName: ["mike3web.com", "Mike Web"],
    ...
    <>
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {[
            { icon: Globe, label: "Website", value: "mike3web.com" },
            { icon: Calendar, label: "Founded", value: "2015" },
            { icon: MapPin, label: "Location", value: "Seattle, WA, USA" },
            { icon: Mail, label: "Email", value: "admin@mike3web.com" },
